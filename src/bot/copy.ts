...
export const COPY: Record<Surface, SurfaceCopy> = {
  bstocks: {
    ...
    start: [
      ...
      "/open NVDA — open the trade panel in the app",
    ...
    help: [
      ...
      "/open &lt;ticker&gt; — a link that opens that stock's trade panel",
  ...
  launchpad: {
    ...
    help: [
      ...
      "/token &lt;address&gt; — price, FDV, holders, volume, creator and the current fee",
